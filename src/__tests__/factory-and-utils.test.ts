...
describe("Factory and Utils", () => {
  describe("randomItemFromArray", () => {
    ...
    it("should throw an error for an empty array", () => {
      ...
      expect(() => randomItemFromArray(engine, [])).toThrow(
        "Can't get an item from an empty array",
      );
    });
  });
  ...
  describe("randomItemsFromArray", () => {
    ...
    it("should throw an error when requesting more items than available", () => {
      const engine = mockEngine([0]);
      expect(() => randomItemsFromArray(engine, [1, 2], 3)).toThrow(
        "You can't request more items than the array size.",
      );
    });

    it("should throw an error when requesting zero or negative items", () => {
      const engine = mockEngine([0]);
      expect(() => randomItemsFromArray(engine, [1, 2, 3], 0)).toThrow(
        "You must request at least 1 item.",
      );
    });
  });
  ...
  describe("randomWithWeights", () => {
    ...
    it("should throw with empty array", () => {
      ...
      expect(() => randomWithWeights(engine, [], () => 1)).toThrow(
        "Can't get an item from an empty array",
      );
    });
